...
(* type of opcodes or operations *)
  type opcode = CONST of bigint | PLUS | TIMES | MINUS | DIV | REM | ABS | UNARYMINUS

(* eval returns final result of expression *)
...
(* Stack machine gives final result of expression by returning the top of stack*)
...
(* Compile fuction returns opcode list *)
